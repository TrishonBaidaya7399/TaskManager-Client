            ...
            {/* <form className="card-body"> */}
              ...
              <div className="form-control">
                <label className="label">
                  <span className="label-text text-yellow-300 font-semibold">Name</span>
                </label>
                <input
                  type="text"
                  placeholder="name"
              ...
              <div className="form-control">
                <label className="label">
                  <span className="label-text text-yellow-300 font-semibold">Profile Image URL</span>
                </label>
                <input
                  type="text"
              ...
              <p className="text-yellow-300 mx-auto">
                Already registered? <Link to="/login"><span className="font-bold">Go to log in</span></Link>
              </p>
              <div className="flex flex-col items-center gap-3 mx-auto">
                <p className="text-yellow-300 font-semibold">Or sign up with</p>
